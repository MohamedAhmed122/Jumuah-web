  ...
  return (
    <>
      ...
      <Stack direction={{ xs: "column", md: "row" }} alignItems={{ xs: "stretch", md: "flex-end" }} justifyContent="space-between" spacing={2} sx={{ mb: 3 }}>
        <Box sx={{ minWidth: 0 }}>
          <Typography variant="h4" sx={{ fontWeight: 700, fontSize: { xs: "2rem", sm: "2.125rem" } }}>Events</Typography>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5}>
          ...
          <Button variant="contained" startIcon={<EventAvailableOutlinedIcon />} disabled={!mosqueId} onClick={openCreate} sx={{ width: { xs: "100%", sm: "auto" } }}>Create event</Button>
        </Stack>
      </Stack>
